...
# Fedora Setup Script
# A modular setup system for Fedora development environment
...
show_menu() {
    clear
    box "Fedora Setup Script - Modular Development Environment Setup"
    echo
...
main() {
    ...
    while true; do
        ...
        case $choice in
            1)
                run_module "system-update" "System Update & RPM Fusion"
                ;;
            2)
