#!/bin/bash
# COSMIC desktop install — single TUI entrypoint.
#
# Usage:
#   ./arch/cosmic/install.sh
#
# Only "COSMIC desktop setup" and "Disk utility" are pre-selected —
...
require_not_root
log_section "COSMIC Desktop Install"
...
checkbox_menu "Select components to install" \
    ...
    "cosmic|COSMIC desktop setup|on"
...
menu_has cosmic        && install_cosmic_component
